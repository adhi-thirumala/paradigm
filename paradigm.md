...
Other conflicts/coaching: Gunn KB (graduated), Edison BB (graduated), Jenks GH (graduated), Whitney Young SV/MB, Unionville HK

Email: debate[at]adhi-thirumala[dot]com
...
A couple of thoughts from an older version of this document that I think are still necessary for me to express (and some that are new). Most of these aren't really "preferences" (I have very few), but rather musings in general about the activity.
